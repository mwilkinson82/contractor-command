...
export const UPSELL_CATALOG: Record<UpsellSku, UpsellCard> = {
  ...
  sm_school: {
    ...
    pitch: "Wednesdays. Build the sales and marketing engine in the live class room.",
    bullets: [
  ...
  hardcore: {
    ...
    pitch: "Everything. Power Hour, S&M School, and Contractor School — the live inner-circle class room.",
    bullets: [
      "Daily Power Hour + S&M School + Contractor School",
      "Live class access",
      "Managed outside the Contractor Circle hub",
    ],
    checkout: "interest",
